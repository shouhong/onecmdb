...
CALL "%ONECMDB_HOME%/bin/transform.bat"  --token %TOKEN% --transform conf/%NAME%/transform.xml --transformType simple --source conf/%NAME%/source.xml  --output result/result_%NAME%.xml
